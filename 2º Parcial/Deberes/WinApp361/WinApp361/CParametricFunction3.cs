    ...
    class CParametricFunction3
    {
                                     ...
                                     ListBox lstXp, ListBox lstYp)
        {
            ...
            for (i = I1, j = 0; i <= I2; i += (float)Math.PI / 180, j++)
            {
                ...
                mX = i - (float)Math.Cos(5 * i); lstX.Items.Add(mX.ToString());
                mY = i + (float)Math.Sin(7 * i); lstY.Items.Add(mY.ToString());
