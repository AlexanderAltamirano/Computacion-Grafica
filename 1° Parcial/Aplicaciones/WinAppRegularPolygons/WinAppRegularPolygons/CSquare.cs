...
namespace WinAppRegularPolygons
{
    class CSquare
    {
        ...
        private PointF mP1, mP2, mP3, mP4;
        ...
        // Función que permite calcular el área del Cuadrado
        public void AreaSquare()
        {
            mArea = mL * mL;
        }

        // Función que permite imprimir el perímetro y el área del cuadrado
        ...
        public void GraphShape(PictureBox picCanvas)
        {
            ...
            mGraph.DrawLine(mPen, mP4.X * SF, mP4.Y * SF, mP1.X * SF, mP1.Y * SF);
